...
## Overview
This tutorial shows how to use Visual Studio tools to help debug an app in [App Service](./overview.md), by running in [debug mode](https://docs.microsoft.com/visualstudio/debugger/) remotely or by viewing application logs and web server logs.
...
If you have Visual Studio Ultimate, you can also use [IntelliTrace](https://docs.microsoft.com/visualstudio/debugger/intellitrace) for debugging. IntelliTrace is not covered in this tutorial.
...
1. If you aren't already signed in to Azure in Visual Studio, right-click **Azure** and select Connect to **21Vianet Azure Subscription** in **Server Explorer**.

    An alternative is to install a management certificate that enables access to your account. If you choose to install a certificate, right-click the **Azure** node in **Server Explorer**, and then select **Manage and Filter Subscriptions** in the context menu. In the **Manage Azure Azure Subscriptions** dialog box, click the **Certificates** tab, and then click **Import**. Follow the directions to download and then import a subscription file (also called a *.publishsettings* file) for your Azure account.
...
3. Expand the resource group that includes the app that you created in [Create an ASP.NET app in Azure App Service](quickstart-dotnet-framework.md), and then right-click the app node and click **View Settings**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-viewsettings.png" alt-text="View Settings in Server Explorer":::
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-configtab.png" alt-text="Azure Web App window":::
...
2. Expand the **Files** node, and double-click the *Web.config* file.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/webconfig.png" alt-text="Open Web.config":::
...
3. Add the following line to the `system.web` element:
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/webconfigedit.png" alt-text="Edit Web.config":::
4. Refresh the browser that is showing the unhelpful error message, and now you get a detailed error message, such as the following example:
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/detailederror.png" alt-text="Detailed error message":::
...
1. In the **Publish** dialog, click the **Settings** tab, and then change **Configuration** to **Debug**, and then click **Save**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-publishdebug.png" alt-text="Publish in debug mode":::
...
1. Hover over the `currentTime` variable to see the time value.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-debugviewinwa.png" alt-text="View variable in debug mode running in Azure":::
...
1. Press F5 to continue running.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-debugchangeinwa.png" alt-text="About page with new value":::

<a name="remotedebugwj"></a>
...
3. [Set a breakpoint](https://docs.microsoft.com/visualstudio/debugger/) on the first statement in the `GnerateThumbnail` method.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/wjbreakpoint.png" alt-text="Set breakpoint":::
...
10. When the debugger breaks at your breakpoint, you can examine and change variable values while the program is running the cloud. In the following illustration, the debugger shows the contents of the blobInfo object that was passed to the `GenerateThumbnail` method.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/blobinfo.png" alt-text="blobInfo object in debugger":::
...
15. Sign in with your Azure credentials, and then click the WebJob name to go to the page for your WebJob.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/clickcaw.png" alt-text="Click ContosoAdsWebJob":::
...
16. Click the function name to see details about the function execution.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/funcdetails.png" alt-text="Function details":::
...
* You can manually attach the debugger to any process, not only the app process (w3wp.exe). For more information about how to use debug mode in Visual Studio, see [Debugging in Visual Studio](https://docs.microsoft.com/visualstudio/debugger/debugging-in-visual-studio).
...
* **Application tracing logs**<br/>
  The application creates these logs by calling methods of the [System.Diagnostics.Trace](https://docs.microsoft.com/dotnet/api/system.diagnostics.trace) class.
* **Web server logs**<br/>
...
1. Press F5 to run the application in debug mode.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-debugtracing.png" alt-text="Tracing in Debug window":::
...
4. In the browser window that shows your application home page, click **Contact**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-errortrace.png" alt-text="Error trace in Output window":::
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-apploggingoff.png" alt-text="Application Logging off":::
...
6. Change **Application Logging (File System)** to **Verbose**, and then click **Save**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-applogverbose.png" alt-text="Setting trace level to Verbose":::
7. In the browser window that is now showing your **Contact** page, click **Home**, then click **About**, and then click **Contact**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-verbosetraces.png" alt-text="Verbose trace output":::
...
The **21Vianet Azure Logs** tab of the **Output** Window has several buttons and a text box:

:::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-icons.png" alt-text="Screenshot showing the buttons and text box of the Azure Azure Logs tab in the Output window.":::
...
1. In the **Azure Web App Configuration** tab that you opened from **Server Explorer**, change Web Server Logging to **On**, and then click **Save**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-webserverloggingon.png" alt-text="Enable web server logging":::
2. In the **Output** Window, click the **Specify which Azure Azure logs to monitor** button.

    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-specifylogs.png" alt-text="Specify which Azure logs to monitor":::
3. In the **21Vianet Azure Logging Options** dialog box, select **Web server logs**, and then click **OK**.

    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-monitorwslogson.png" alt-text="Monitor web server logs":::
4. In the browser window that shows the app, click **Home**, then click **About**, and then click **Contact**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-wslogs.png" alt-text="Web server logs in Output window":::
...
1. In the **Azure Web App Configuration** tab that you opened from **Server Explorer**, change **Detailed Error Messages** to **On**, and then click **Save**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-detailedlogson.png" alt-text="Enable detailed error messages":::

2. In the **Output** Window, click the **Specify which Azure Azure logs to monitor** button.

3. In the **21Vianet Azure Logging Options** dialog box, click **All logs**, and then click **OK**.

    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-monitorall.png" alt-text="Monitor all logs":::
...
4. In the address bar of the browser window, add an extra character to the URL to cause a 404 error (for example, `http://localhost:53370/Home/Contactx`), and press Enter.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-detailederrorlog.png" alt-text="Detailed error log - Output window":::

    Control+click the link to see the log output formatted in a browser:

    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-detailederrorloginbrowser.png" alt-text="Detailed error log - browser window":::
...
:::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/createstor.png" alt-text="Create Storage Account":::
...
4. Click **Create**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/newstorage.png" alt-text="New storage account":::    
5. In the Visual Studio **Azure Web App** window, click the **Logs** tab, and then click **Configure Logging in Management Portal**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-configlogging.png" alt-text="Configure logging":::
...
8. Click **Manage Table Storage**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-stgsettingsmgmtportal.png" alt-text="Click Manage TableStorage":::
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-choosestorageacct.png" alt-text="Manage table storage":::
...
12. In the **Logs** tab of the **Azure Web App** window in Visual Studio, click **Refresh** under **Diagnostic Summary**.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-refreshstorage.png" alt-text="Click Refresh":::
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-storagelogs.png" alt-text="Storage logs":::
...
13. Click **View all application logs**.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-tracelogtableview.png" alt-text="Storage logs in table view":::
...
14. To look at the details for a single row, double-click one of the rows.
     ...
     :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-tracetablerow.png" alt-text="Trace table in Server Explorer":::
 -->
...
1. In the **Configuration** tab of the **Azure Web App** window that you opened from **Server Explorer**, change **Failed Request Tracing** to **On**, and then click **Save**.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-failedrequeston.png" alt-text="Enable failed request tracing":::
...
4. In the [Azure portal](https://portal.azure.cn) **Settings** page for your app, click **Deployment credentials**, and then enter a new user name and password.

    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-enterftpcredentials.png" alt-text="New FTP user name and password":::
...
7. Open the *LogFiles* folder.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-logfilesfolder.png" alt-text="Open LogFiles folder":::

8. Open the folder that is named W3SVC plus a numeric value.

    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-w3svcfolder.png" alt-text="Open W3SVC folder":::
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-w3svcfoldercontents.png" alt-text="W3SVC folder":::
...
9. Click the XML file for the failed request that you want to see tracing information for.
    ...
    :::image type="content" source="./media/web-sites-dotnet-troubleshoot-visual-studio/tws-failedrequestinbrowser.png" alt-text="Failed request tracing in browser":::
...
* [Investigating Memory Leaks in Azure App Service with Visual Studio 2013](https://devblogs.microsoft.com/devops/investigating-memory-leaks-in-azure-web-sites-with-visual-studio-2013/). Azure ALM blog post about Visual Studio features for analyzing managed memory issues.
...
* [The Azure forum on Azure Q&A](https://docs.microsoft.com/answers/topics/azure-webapps.html).
* [StackOverflow.com](https://www.stackoverflow.com).

### Debugging in Visual Studio
For more information about how to use debug mode in Visual Studio, see [Debugging in Visual Studio](https://docs.microsoft.com/visualstudio/debugger/debugging-in-visual-studio) and [Debugging Tips with Visual Studio 2010](https://weblogs.asp.net/scottgu/archive/2010/08/18/debugging-tips-with-visual-studio-2010.aspx).
...
* [WebJobs Debugging (video)](https://www.youtube.com (THIS WEB SITE IS NOT AVAILABLE ON AZURE CHINA CLOUD) /watch?v=ncQm9q5ZFZs&list=UU_SjTh-ZltPmTYzAybypB-g&index=1)

If your app uses an Azure Web API or Mobile Services back-end and you need to debug that, see [Debugging .NET Backend in Visual Studio](https://docs.microsoft.com/archive/blogs/azuremobile/debugging-net-backend-in-visual-studio).
...
* [ASP.NET Tracing](https://docs.microsoft.com/previous-versions/dotnet/articles/ms972204(v=msdn.10))<br/>
  Old but still a good resource for a basic introduction to the subject.
* [Trace Listeners](https://docs.microsoft.com/dotnet/framework/debug-trace-profile/trace-listeners)<br/>
  Information about trace listeners but doesn't mention the [WebPageTraceListener](https://docs.microsoft.com/dotnet/api/system.web.webpagetracelistener).
* [Walkthrough: Integrating ASP.NET Tracing with System.Diagnostics Tracing](https://docs.microsoft.com/previous-versions/b0ectfxd(v=vs.140))<br/>
...
* [Using Web Apps Logging and Diagnostics - with David Ebbo](https://www.azure.cn/documentation/videos/azure-web-site-logging-and-diagnostics/) and [Streaming Logs from Web Apps - with David Ebbo](https://www.azure.cn/documentation/videos/log-streaming-with-azure-web-sites/)<br />
