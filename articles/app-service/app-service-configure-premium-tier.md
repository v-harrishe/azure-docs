...
**PremiumV3** is available in some Azure regions and availability in additional regions is being added continually. To see if it's available in your region, run the following Azure CLI command in the [Azure local Shell](../cloud-shell/overview.md):
...
When configuring the App Service plan in the <a href="https://portal.azure.cn" target="_blank">Azure portal</a>, select **Pricing tier**. 

Select **Production**, then select **P1V3**, **P2V3**, or **P3V3**, then click **Apply**.

:::image type="content" source="media/app-service-configure-premium-tier/scale-up-tier-select.png" alt-text="Screenshot showing the recommended pricing tiers for your app.":::
...
In the <a href="https://portal.azure.cn" target="_blank">Azure portal</a>, open your App Service app page.
...
:::image type="content" source="media/app-service-configure-premium-tier/finished.png" alt-text="Screenshot showing the PremiumV3 pricing tier on your app's overview page.":::
...
You can automate app creation in the **PremiumV3** tier with scripts, using the [Azure CLI](https://docs.azure.cn/cli/install-azure-cli) or [Azure PowerShell](https://docs.microsoft.com/powershell/azure/).

### Azure CLI

The following command creates an App Service plan in _P1V3_. You can run it in the local Shell. The options for `--sku` are P1V3, _P2V3_, and _P3V3_.
...
<!-- Update_Description: new article about app service configure premium tier -->
<!--NEW.date: 12/21/2020-->