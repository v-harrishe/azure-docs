...
| [`az appservice plan update`](https://docs.azure.cn/cli/appservice/plan#az_appservice_plan_update) | Updates properties of the App Service plan. |
...
<!-- Update_Description: new article about cli scale manual -->
<!--NEW.date: 12/21/2020-->