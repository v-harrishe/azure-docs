...
| [`az redis create`](https://docs.azure.cn/cli/redis#az_redis_create) | Create new Azure Cache for Redis instance. |
| [`az redis list-keys`](https://docs.azure.cn/cli/redis#az_redis_list_keys) | Lists the access keys for the Azure Cache for Redis instance. |
...
<!-- Update_Description: new article about cli connect to redis -->
<!--NEW.date: 12/21/2020-->