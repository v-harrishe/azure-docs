...
If you happened to accidentally delete your app in Azure App Service, you can restore it using the commands from the [Az PowerShell module](https://docs.microsoft.com/powershell/azure/).
...
<!-- Update_Description: new article about app service undelete -->
<!--NEW.date: 12/21/2020-->