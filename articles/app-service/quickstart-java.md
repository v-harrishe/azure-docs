...
[Azure App Service](overview.md) provides a highly scalable, self-patching web hosting service.  This quickstart shows how to use the [Azure CLI](https://docs.azure.cn/cli/get-started-with-azure-cli) with the [Azure Web App Plugin for Maven](https://github.com/Microsoft/azure-maven-plugins/tree/develop/azure-webapp-maven-plugin) to deploy a .jar file, or .war file. Use the tabs to switch between Java SE and Tomcat instructions.


> [!NOTE]
> The same can also be done using popular IDEs like IntelliJ and Eclipse. Check out our similar documents at [Azure Toolkit for IntelliJ Quickstart](https://docs.azure.cn/azure/developer/java/toolkit-for-intellij/create-hello-world-web-app) or [Azure Toolkit for Eclipse Quickstart](https://docs.azure.cn/azure/developer/java/toolkit-for-eclipse/create-hello-world-web-app).


:::image type="content" source="./media/quickstart-java/java-hello-world-in-browser-azure-app-service.png" alt-text="Sample app running in Azure App Service":::
...
Execute the following Maven command in the local Shell prompt to create a new app named `helloworld`:
...
`<region>` | true | Specifies the region where your Web App will be hosted; the default value is **westeurope**. All valid regions at [Supported Regions](https://docs.azure.cn/java/api/overview/maven/azure-webapp-maven-plugin/readme) section. | 0.1.0+
`<pricingTier>` | false | The pricing tier for your Web App. The default value is **P1V2** for production workload, while **B2** is the recommended minimum for Java dev/test. [Learn more](https://www.azure.cn/pricing/details/app-service/linux/)| 0.1.0+
...
The Maven plugin uses account credentials from the Azure CLI to deploy to App Services. [Sign in with the Azure CLI](https://docs.azure.cn/cli/authenticate-azure-cli) before continuing.
...
In the preceding steps, you created Azure resources in a resource group. If you don't expect to need these resources in the future, delete the resource group from portal, or by running the following command in the local Shell:
...
> [!div class="nextstepaction"]
> [Pricing Information](https://www.azure.cn/pricing/details/app-service/linux/)
...
> [!div class="nextstepaction"]
> [Azure for Java Developers Resources](https://docs.azure.cn/java/)
...
<!-- Update_Description: new article about quickstart java -->
<!--NEW.date: 12/21/2020-->