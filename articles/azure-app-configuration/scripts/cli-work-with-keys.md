...
| Command | Notes |
|---|---|
| [az appconfig kv set](https://docs.azure.cn/cli/appconfig/kv#az_appconfig_kv_set) | Create or update a key-value pair. |
| [az appconfig kv list](https://docs.azure.cn/cli/appconfig/kv#az_appconfig_kv_list) | List key-value pairs in an App Configuration store. |
| [az appconfig kv delete](https://docs.azure.cn/cli/appconfig/kv#az_appconfig_kv_delete) | Delete a key-value pair. |
...
<!-- Update_Description: new article about cli work with keys -->
<!--NEW.date: 12/21/2020-->