...
- [Java API reference](https://docs.azure.cn/java/api/overview/servicebus?preserve-view=true&view=azure-java-stable)
...
<!-- Update_Description: new article about service bus java how to use queues -->
<!--NEW.date: 12/21/2020-->