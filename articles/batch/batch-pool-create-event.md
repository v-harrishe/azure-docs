...
|`targetLowPriorityNodes`|Int32|The number of low-priority(THIS FEATURE IS NOT AVAILABLE ON AZURE CHINA CLOUD) compute nodes that are requested for the pool.|
...
<!-- Update_Description: new article about batch pool create event -->
<!--NEW.date: 12/21/2020-->