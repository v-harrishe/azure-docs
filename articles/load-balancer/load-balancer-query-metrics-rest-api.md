...
Collect the number of bytes processed by a [Standard Load Balancer](./load-balancer-overview.md) for an interval of time using the [Azure REST API](https://docs.microsoft.com/rest/api/azure/).

Complete reference documentation and additional samples for the REST API are available in the [Azure Monitor REST reference](https://docs.microsoft.com/rest/api/monitor). 
...
| Name | Description |
| :--- | :---------- |
| subscriptionId | The subscription ID that identifies an Azure subscription. If you have multiple subscriptions, see [Working with multiple subscriptions](https://docs.azure.cn/cli/manage-azure-subscriptions-azure-cli). |
...
Status code 200 is returned when the list of metric values is returned successfully. A full list of error codes is available in the [reference documentation](https://docs.microsoft.com/rest/api/monitor/metrics/list#errorresponse).
...
<!-- Update_Description: new article about load balancer query metrics rest api -->
<!--NEW.date: 12/21/2020-->