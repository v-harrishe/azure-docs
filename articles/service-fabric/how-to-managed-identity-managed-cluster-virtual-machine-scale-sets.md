...
* If you don't have an Azure subscription, create a [free](https://www.azure.cn/free/) account before you begin.
* If you plan to use PowerShell, [install](https://docs.azure.cn/cli/install-azure-cli) the Azure CLI to run CLI reference commands.
...
> [Deploy an app to a Service Fabric managed cluster](https://docs.azure.cn/service-fabric/tutorial-managed-cluster-deploy-app) 



<!-- Update_Description: new article about how to managed identity managed cluster virtual machine scale sets -->
<!--NEW.date: 12/21/2020-->