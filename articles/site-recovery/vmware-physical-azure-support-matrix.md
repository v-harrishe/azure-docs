...
Group policies| - Prevent access to the command prompt. <br/> - Prevent access to registry editing tools. <br/> - Trust logic for file attachments. <br/> - Turn on Script Execution. <br/> - [Learn more](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-7/gg176671(v=ws.10))|
IIS | Make sure you:<br/><br/> - Don't have a pre-existing default website <br/> - Enable  [anonymous authentication](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc731244(v=ws.10)) <br/> - Enable [FastCGI](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc753077(v=ws.10)) setting  <br/> - Don't have preexisting website/app listening on port 443<br/>
...
Logical volume management (LVM) provisioning| Thick provision - Yes <br /> Thin provision - No
...
Guest/server disk > 1 TB | Yes, disk must be larger than 1024 MB<br/><br/>Up to 8,192 GB when replicating to managed disks (9.26 version onwards)<br /> Up to 4,095 GB when replicating to storage accounts
...
Logical volume management (LVM)| Thick provisioning - Yes <br /> Thin provisioning - No
...
Data disk size | Up to 8,192 GB when replicating to managed disk (9.26 version onwards)<br />Up to 4,095 GB when replicating to storage account| Check fails if unsupported.
...
<!-- Update_Description: new article about vmware physical azure support matrix -->
<!--NEW.date: 12/21/2020-->